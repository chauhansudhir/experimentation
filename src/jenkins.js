/**
 * Source: https://raw.githubusercontent.com/vkandy/jenkins-hash-js/master/src/jenkins.js
 * Jenkins hash implementation which yeilds 32-bit and 64-bit hashes.
 * https://github.com/vkandy/jenkins-hash-js#usage
 * // Usage:
 * var j = new Jenkins();
 * var hash32 = j.hash32("");
 * var hash64 = j.hash64("");
 */
export default new function(seeds) {
    /**
